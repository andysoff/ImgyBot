...
const RUSSIAN_MOVIES = [
  ...
  { title: 'Война', titleEn: 'War', year: 2002,
    prompt: 'Chechen war drama aesthetic, military fatigues, Caucasian forest, tense hostage situation, Balabanov stark war realism style' },
  { title: 'Груз 200', titleEn: 'Cargo 200', year: 2007,
    prompt: '1980s Soviet provincial aesthetic, 80s fashion, run-down town, grim faded colors, Balabanov disturbing psychological style' },
  { title: 'Александра', titleEn: 'Alexandra', year: 2007,
    prompt: 'Chechen war contemplative aesthetic, elderly woman in summer dress, military camp, Chechen landscape, Sokurov lyrical style' },
  ...
  { title: 'Монгол', titleEn: 'Mongol', year: 2007,
    prompt: 'Mongolian epic aesthetic, warrior armor, vast steppe landscape, golden war paint, Bodrov historical epic style' },
  ...
  { title: 'Адмиралъ', titleEn: 'The Admiral', year: 2008,
    prompt: 'Russian Civil War epic aesthetic, white naval uniform, Siberian winter, tragic romance, historical epic style' },
  ...
  { title: '28 панфиловцев', titleEn: 'Panfilov\'s 28 Men', year: 2016,
    prompt: 'WWII battle aesthetic, Soviet soldier greatcoat, snowy battlefield, tank attack, defiant war epic style' },
  ...
  { title: 'Скиф', titleEn: 'The Scythian', year: 2018,
    prompt: 'ancient Scythian aesthetic, fur and leather warrior garb, Eurasian steppe, brutal sword and arrow action, dark historical fantasy style' },
  { title: 'Дуэлянт', titleEn: 'The Duelist', year: 2016,
    prompt: '19th century St. Petersburg aesthetic, elegant nobility attire, dueling pistols, foggy capital, stylish period drama style' },
  ...
  { title: 'Ржев', titleEn: 'Rzhev', year: 2019,
    prompt: 'WWII Eastern Front aesthetic, Red Army winter uniform, snowy forest trench, grim battle realism, intimate war drama style' },
  { title: 'Девятаев', titleEn: 'Devyatayev', year: 2021,
    prompt: 'WWII escape drama aesthetic, Soviet pilot uniform, German airfield, captured plane, tense war thriller style' },
  { title: 'Рай', titleEn: 'Paradise', year: 2016,
    prompt: 'WWII European drama aesthetic, 1940s elegant dress, refugee camp, Parisian luxury hotel, black and white, Konchalovsky epic style' },
  ...
  { title: 'Праведник', titleEn: 'The Righteous', year: 2023,
    prompt: 'WWII partisan aesthetic, winter coat and hat, Belarusian forest, rescue mission, heroic historical drama style' },
  ...
  { title: 'Балканский рубеж', titleEn: 'The Balkan Line', year: 2019,
    prompt: 'Kosovo war aesthetic, military tactical gear, Balkan airport, night operation, tense modern war style' },
...
const SOVIET_MOVIES = [
  ...
  { title: 'Иди и смотри', titleEn: 'Come and See', year: 1985,
    prompt: 'WWII Belarusian tragedy aesthetic, teenage boy in ragged clothes, burned village, dark forest, Klimov harrowing surreal war style' },
  { title: 'Война и мир', titleEn: 'War and Peace', year: 1967,
    prompt: 'Napoleonic era epic aesthetic, 19th century ball gown and military uniform, Borodino battlefield, sweeping Bondarchuk Oscar-winning epic style' },
  ...
  { title: 'Три мушкетёра', titleEn: 'The Three Musketeers', year: 1978,
    prompt: '17th century French aesthetic, musketeer cloak and rapier, palace of Louvre, swashbuckling adventure, Jungvald-Khilkevich musical style' },
  ...
  { title: 'Семнадцать мгновений весны', titleEn: 'Seventeen Moments of Spring', year: 1973,
    prompt: 'WWII spy thriller aesthetic, SS uniform and German trench coat, Nazi Berlin, black Gestapo offices, Lioznova tense espionage style' },
  ...
  { title: 'Майор Вихрь', titleEn: 'Major Whirlwind', year: 1967,
    prompt: 'WWII spy aesthetic, Polish resistance style, Krakow old town, Nazi occupation, secret mission thriller style' },
  ...
  { title: 'Обыкновенный фашизм', titleEn: 'Ordinary Fascism', year: 1965,
    prompt: 'WWII documentary aesthetic, archival newsreel, Hitler rallies, concentration camps, Romm powerful essay film style' },
  ...
  { title: 'Проверка на дорогах', titleEn: 'Trial on the Road', year: 1971,
    prompt: 'WWII partisan aesthetic, Soviet and German uniforms, snow-covered forest, moral dilemmas, German stark war drama style' },
  { title: 'Мой друг Иван Лапшин', titleEn: 'My Friend Ivan Lapshin', year: 1984,
    prompt: '1930s Soviet provincial aesthetic, NKVD uniform, communal apartment, bleak winter town, German naturalist drama style' },
  ...
  { title: 'Ворошиловский стрелок', titleEn: 'The Voroshilov Sharpshooter', year: 1999,
    prompt: '1990s Russian provincial revenge aesthetic, elderly man in suit, small apartment, air rifle, Govorukhin tense justice drama style' },
  ...
  { title: 'Горячий снег', titleEn: 'Hot Snow', year: 1972,
    prompt: 'WWII Stalingrad battle aesthetic, Red Army soldier greatcoat, snowy steppe, tank battle, Egoryev epic war style' },
  { title: 'Освобождение', titleEn: 'Liberation', year: 1971,
    prompt: 'WWII epic battle aesthetic, Red Army and Nazi uniforms, Kursk and Berlin, massive scale, Ozerov epic war saga style' },
  { title: 'Битва за Москву', titleEn: 'Battle of Moscow', year: 1985,
    prompt: 'WWII Moscow defense aesthetic, Soviet winter uniform, snow-covered battlefield, Kremlin backdrop, grand historical war style' },
  ...
  { title: 'Живые и мёртвые', titleEn: 'The Living and the Dead', year: 1964,
    prompt: 'WWII retreat aesthetic, Soviet officer uniform, Belarusian forest, chaotic war scenes, Stolper epic war drama style' },
  ...
  { title: 'Иваново детство', titleEn: 'Ivan\'s Childhood', year: 1962,
    prompt: 'WWII Soviet aesthetic, boy in military coat, burned forest, river crossing, Tarkovsky poetic black and white war style' },
  ...
  { title: 'Тегеран-43', titleEn: 'Teheran-43', year: 1981,
    prompt: 'WWII spy thriller aesthetic, 1940s international suits and dresses, Tehran city, assassination plot, Alov globe-trotting style' },
  ...
  { title: 'В шесть часов вечера после войны', titleEn: 'At Six O\'Clock in the Evening After the War', year: 1944,
    prompt: 'WWII home front musical aesthetic, military uniform and elegant dress, Moscow fireworks, celebrating victory, Pyryev hopeful musical style' },
